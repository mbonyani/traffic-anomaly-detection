# -*- coding: utf-8 -*-
"""breast_cancer_preprocessing_2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1FYCcsc-aqof2PAxqWWbAeluTQ1IXalAX
"""
...
# kamel
def breast_cancer_preprocessing_2(encoder_numeric,encoder_categoric,scaler_name):

  dataset_name = 'breast_cancer'
  from sklearn.datasets import load_breast_cancer
  breast_cancer = load_breast_cancer(return_X_y=False, as_frame=True)
  ...
  label = np.where(label == 0, 'Malignant' ,'Benign')
