# -*- coding: utf-8 -*-
"""ugr16_preprocessing_2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1vfFPl6qIk6JjcJRs3vqeojsM03_X9Pt9
"""
...
# kamel
def UGR16_preprocessing_2(encoder_numeric,encoder_categoric,scaler_name,tar_path,df_path):
  ...
  tar.extractall()
  tar.close()
  df = pd.read_csv(df_path, sep=',', skiprows= 100, nrows=10000000)
  ...
  df = df.rename(columns = {'Label' : 'binary_target'})
