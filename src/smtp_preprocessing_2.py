# -*- coding: utf-8 -*-
"""smtp_preprocessing_2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1LZ_71G050GevdjBaHS-7uh1703ccyWqT
"""
...
# kamel
def smtp_preprocessing_2(encoder_numeric,encoder_categoric,scaler_name):

  dataset_name = 'smtp'
  from sklearn.datasets import fetch_kddcup99
  smtp = fetch_kddcup99(subset='smtp', data_home=None, shuffle=False, random_state=None, percent10=True, 
  ...
  # anomaly_rate = 1.0 - len(df.loc[df[name_target]==normal])/ len(df)
  ...
  #********************************************table
  from beautifultable import BeautifulTable
  table = BeautifulTable(maxwidth=200,precision=5)
  table.set_style(BeautifulTable.STYLE_RST)

  table.rows.append([num_row , num_colmn-1, anomaly_class, contamination,
