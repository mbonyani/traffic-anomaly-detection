# -*- coding: utf-8 -*-
"""credit_card_fraud_preprocessing_2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1q5RVbhMHFUlxFgXgMlopxJkGDZRU5v2o
"""
...
def credit_card_fraud_preprocessing_2(encoder_numeric,encoder_categoric,scaler_name,dataset_kaggle_path,dataset_dir):
 
  dataset_name = 'credit_card_fraud'
  download_drive(dataset_kaggle_path,dataset_dir)
  df= pd.read_csv(f'{dataset_dir}creditcard.csv')
  ...
  df = df.rename(columns = {'Class' : 'binary_target'})  
