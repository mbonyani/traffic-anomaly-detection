# -*- coding: utf-8 -*-
"""pima_diabets_preprocessing_2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Z4EkIcWH7qBKy0Czxqu2DRcD7OH7Zam1
"""
...
# kamel
def pima_diabets_preprocessing_2(encoder_numeric,encoder_categoric,scaler_name,dataset_kaggle_path,dataset_dir):
 
  dataset_name = 'pima_diabets'
  download_drive(dataset_kaggle_path,dataset_dir)
  df= pd.read_csv(f'{dataset_dir}diabetes.csv')
  ...
  df = df.rename(columns = {'Outcome' : 'binary_target'})  
