...
Original file is located at
    https://colab.research.google.com/drive/1zky3AtRWy833yXKidAQSDXjMaNbJPmZN
"""
...
# kamel
def pen_global(encoder_numeric,encoder_categoric,scaler_name,dataset_path):
 
  dataset_name = 'pen_global'
